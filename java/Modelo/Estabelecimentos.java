...
public class Estabelecimentos implements Serializable {
    ...
    public Estabelecimentos(String est_cidade, String est_nome, String est_desc, String est_rua, String est_bairro, String est_uf) {
    ...
    public String getEst_cidades() {
        return est_cidades;
    }

    public void setEst_cidades(String est_cidades) {
